...
public class AppAcademia {
	...
	public static void main(String[] args) {
		...
		Cliente ana = new Cliente(); // "new client" reserve a space in the ram memory,so we have to attribute it
										// something.
		...
		// Library used to create frames: JFrame //Jlabel = exactly a label //JtextField
		// = used to create text field
